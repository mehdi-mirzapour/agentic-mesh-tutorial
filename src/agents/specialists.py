...
class SpecialistAgent(BaseAgent):
    ...
    def process_message(self, message_id, data):
        ...
        suggestion = {
            ...
            "suggested_text": f"[Suggestion] {self.specialty.capitalize()} improvement for: {text[:20]}...",
            "explanation": f"This is a dummy explanation from the {self.specialty} agent to split infinitives or whatever.",
